...
[Download Resume](https://drive.google.com/file/d/1fmJQYUSRIxbE1_InfI04zPLWMKuUDJdi/view)

---

## Cloud Resume Challenge

[View Cloud Resume Challenge](https://resume.shubhamjoshi.xyz/)
...
## Cloud Research Intern — ECS, Syracuse University, Syracuse, NY  
**July 2025 – Present**
...
## Personalized Movie Recommender Using Neo4j Knowledge Graphs  
**Data Engineering, Graph ML — April 2026**
...
**Distributed Systems, AWS, Microservices — March 2026**
...
## Cloud Resume Challenge  
**AWS, Terraform, CI/CD — January 2026**
...
## Electricity Price Prediction Using SARIMAX & Gradient Boosting  
**Python, ML Pipelines — April 2025**
...
* AWS (EC2, ECS, Lambda, API Gateway, S3, CloudFront, DynamoDB, RDS, Cognito, Route53)
* Docker
* Terraform
* GitHub Actions
